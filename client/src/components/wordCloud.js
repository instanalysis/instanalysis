const ignoredWords = ['the', 'a', 'an', 'and', 'of', 'on', 'in', 'at', 'was', 'he', 'she', 'it', '-', 'for', 'nor', 'but', 'or', 'yet', 'so', 'after', 'although', 'as', 'as if', 'because', 'before', 'by', ' even', 'if', 'even', 'though']
...
const countOccurrencesWordsInString = (str) => {  
  ...
  for (var x=0; x<split.length; x++){
    if(!ignoredWords.includes(split[x])) {
